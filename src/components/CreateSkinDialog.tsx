...
import { SkinRarity } from '@/schema';

interface CreateSkinDialogProps {
  onSuccess?: () => void;
  trigger?: React.ReactNode;
}

export function CreateSkinDialog({
  onSuccess,
  trigger,
}: CreateSkinDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error?.message || 'Failed to create skin');
    }
  };
